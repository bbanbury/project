...
##  ---          header          ---  ##
  headerPanel(
    title=HTML(paste(tags$span(style="color:#33D6AD", "shiny"), tags$span(style="color:#9F5F9F", "Priors"), sep="")), windowTitle="shinyPriors"),



##  ---         side bar         ---  ##
  sidebarPanel(
    a("See GitHub for full code base", href="https://github.com/bbanbury/projects/"),
    br(),
